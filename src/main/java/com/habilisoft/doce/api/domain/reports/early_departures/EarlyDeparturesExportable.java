...
public class EarlyDeparturesExportable implements Exportable {
    ...
    public EarlyDeparturesExportable(List<Map<String, String>> records, ExportRequest exportRequest, String filterType){
        this(exportRequest.getCaption(), records, exportRequest.getUserFieldsToExport(), filterType, exportRequest.getUserFilters());
    }

    public EarlyDeparturesExportable(String caption, List<Map<String, String>> records, List<String> userFieldsToExport, String filterType) {
        this(caption, records, userFieldsToExport, filterType, Collections.emptyList());
    }

    public EarlyDeparturesExportable(String caption, List<Map<String, String>> records, List<String> userFieldsToExport, String filterType, List<UserFilter> userFilters) {
    ...
    private void setFieldsMetaInfo() {
        fieldsMetaInfo = new ArrayList<>() {{
            ...
            add(new FieldMetaInfo("hour", "Hora de Salida"));
            add(new FieldMetaInfo("difference", "Tiempo Adelantado"));
        }};
    }
