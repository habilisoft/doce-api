...
import com.habilisoft.doce.api.reporting.export.enums.DataFormatType;
...
public class ExcelExporter implements Exporter {
    ...
    public Resource export(Exportable exportable) throws IOException {
        ...
        this.createCaption(exportable.getReport().getName());
        this.createUserFilters(exportable.getUserFilters());
        this.createHeaders();
        this.createRows();
        this.autoSizeColumns(exportable.getReport().getUiColumns().size());
    ...
    public void init(Exportable exportable) {
        ...
        this.lastColumnIndex = exportable.getReport().getUiColumns().size() + START_COLUMN_NUMBER - 1;
    }
    ...
    public void createCaption(String caption) {
        ...
        sheet.addMergedRegion(new CellRangeAddress(0, 2, START_COLUMN_NUMBER, exportable.getReport().getUiColumns().size() + START_COLUMN_NUMBER - 1));
    }
    ...
    public void createUserFilters(List<UserFilter> userFilters) {
        ...
        sheet.addMergedRegion(new CellRangeAddress(3, 4, START_COLUMN_NUMBER, exportable.getReport().getUiColumns().size() + START_COLUMN_NUMBER - 1));
        CellStyle cellStyle = this.workbook.createCellStyle();
    ...
    public void createFilter(UserFilter userFilter) {
        ...
        cellKey.setCellValue(new XSSFRichTextString(userFilter.getDisplayName() + ": "));
        ...
        cellValue.setCellValue(new XSSFRichTextString(userFilter.getDisplayValue()));
